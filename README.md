...
* Software Engineer working with **TypeScript, JavaScript, React, Next.js, and Node.js**
* Experience building **serverless systems** and backend APIs
* Previous experience as a **DevOps Engineer**
* Comfortable with **Java** and backend development concepts
* Interested in **system design, clean architecture, testing, and code quality**
* Focused on building reliable, maintainable, and scalable software
...
* Building production-ready applications with **TypeScript, React, Next.js, and Node.js**
* Improving my knowledge of **system design**
* Writing cleaner and more testable code
* Working with **serverless architecture**
* Improving developer experience and software quality
